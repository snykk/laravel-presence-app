...
namespace Illuminate\Support {
    ...
    class Collection
    {
        ...
        {
            return self::downloadExcel($fileName, $writerType, $withHeadings);
        }
...
namespace Cms\Facades {
    class CmsForm
    {
         ...
         * @param array  $options
         *
         * @return \Cms\Blade\FormGroup
         *
         * @static
         */
        public static function color($name, $options = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->color($name, $options);
        }

        /**
         * Close the last multilingual form group.
         *
         * @return \Cms\Blade\FormBuilder
         *
         * @static
         */
        public static function closeMultilingualGroup()
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->closeMultilingualGroup();
        }
         ...
         * @static
         */
        public static function createMultilingualGroup($locale)
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->createMultilingualGroup($locale);
        }
        ...
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->date($name, $options);
        }
         ...
         * @static
         */
        public static function datetime($name, $options = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->datetime($name, $options);
        }
        ...
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->email($name, $options);
        }
        ...
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->number($name, $options);
        }
         ...
         * @static
         */
        public static function range($name, $options = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->range($name, $options);
        }
         ...
         * @static
         */
        public static function select($name, $list = [], $selectAttributes = [], $optionsAttributes = [], $optgroupsAttributes = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->select($name, $list, $selectAttributes, $optionsAttributes, $optgroupsAttributes);
        }
         ...
         * @static
         */
        public static function selectRange($name, $begin, $end, $options = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->selectRange($name, $begin, $end, $options);
        }
         ...
         * @static
         */
        public static function tel($name, $options = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->tel($name, $options);
        }
        ...
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->text($name, $options);
        }
        ...
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->textarea($name, $options);
        }
         ...
         * @static
         */
        public static function time($name, $options = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->time($name, $options);
        }
         ...
         * @static
         */
        public static function url($name, $options = [])
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->url($name, $options);
        }

        /**
         * Set the error bag.
         *
         * @param \Illuminate\Support\ViewErrorBag $errorBag
         *
         * @static
         */
        public static function setErrorBag($errorBag)
        {
            /** @var \Cms\Blade\FormBuilder $instance */
            return $instance->setErrorBag($errorBag);
        }
    }
    ...
    class CmsMenu
    {
        ...
        {
            /** @var \Cms\Blade\MenuBuilder $instance */
    ...
    class SEO
    {
        ...
        {
            /** @var \Cms\Services\SeoService $instance */
            return $instance->getMetaValue($key);
        }
         ...
         * @param string $value
         *
         * @return \Cms\Services\SeoService
         *
         * @static
         */
        ...
        {
            /** @var \Cms\Services\SeoService $instance */
            return $instance->setMetaValue($key, $value);
        }
...
namespace Collective\Html {
    ...
    class FormBuilder
    {
        ...
        public static function captcha($attributes = [])
        {
            return self::captcha($attributes);
        }
    }
}
...
namespace Illuminate\Routing {
    ...
    class Router
    {
        ...
        public static function mediaLibrary($baseUrl = 'media-library-pro')
        {
            return self::mediaLibrary($baseUrl);
        }
    }
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
        ...
        /**
         * @see \Cms\Providers\CmsServiceProvider::registerWhereLikeMacroToBuilder()
         *
         * @param mixed  $attributes
    ...
    class CmsForm extends \Cms\Facades\CmsForm
    {
    }
    class CmsMenu extends \Cms\Facades\CmsMenu
    {
    }
    class SEO extends \Cms\Facades\SEO
    {
    }

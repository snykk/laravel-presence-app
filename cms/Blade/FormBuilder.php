...
class FormBuilder
{
    ...
    /**
     * Create a datetime Local input form group.
     *
     * @param string $name
     * @param array  $options
     *
     * @return FormGroup
     */
    public function datetimeLocal(string $name, array $options = []): FormGroup
    {
        return $this->generateInput('datetimeLocal', $name, $options);
    }

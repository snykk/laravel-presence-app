...
class MultilingualForm implements Htmlable
{
    ...
    protected static $template = [
        ...
        'multiCharCountSeoTitle'       => '<div class="font-size-m text-info"><p id="titleCharNumSEOTitle<?php echo $_locale->language; ?>">0 characters.</p></div>',
        'multiCharCountSeoDesc'        => '<div class="font-size-m text-info"><p id="titleCharNumSEODesc<?php echo $_locale->language; ?>">0 characters.</p></div>',
        'multiCharCountSeoKeyword'     => '<div class="font-size-m text-info"><p id="titleCharNumSEOKeyword<?php echo $_locale->language; ?>">0 characters.</p></div>',
    ];
    ...
    /**
     * Get Multi Character Count SEO Title Elements.
     *
     * @return string
     */
    public function getMultiCharacterCountSeoTitleElements(): string
    {
        return ($this->getLocaleCount() > 1) ? self::$template['multiCharCountSeoTitle'] : 'No Character Count Template';
    }

    /**
     * Get Multi Character Count SEO Description Elements.
     *
     * @return string
     */
    public function getMultiCharacterCountSeoDescElements(): string
    {
        return ($this->getLocaleCount() > 1) ? self::$template['multiCharCountSeoDesc'] : 'No Character Count Template';
    }

    /**
     * Get Multi Character Count SEO Keyword Elements.
     *
     * @return string
     */
    public function getMultiCharacterCountSeoKeywordElements(): string
    {
        return ($this->getLocaleCount() > 1) ? self::$template['multiCharCountSeoKeyword'] : 'No Character Count Template';
    }

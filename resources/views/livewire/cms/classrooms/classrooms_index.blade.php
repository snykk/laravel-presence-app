            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        @if($this->currentAdmin->can('cms.classrooms.create'))
                        <button wire:click="performAction('create')" type="button" class="btn mr-1 btn-primary">
                            <i class="fa fa-plus"></i> New Classroom
                        </button>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-md-12 text-md-right text-center">
                            <div class="btn-group" role="group">
                                <button class="btn mr-1 mb-2 btn-info dropdown-toggle" data-toggle="dropdown"
                            ...
                            <div class="btn-group" role="group">
                                <button class="btn mr-1 mb-2 btn-success dropdown-toggle" data-toggle="dropdown"
                                  aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-reply"></i> Export
                                </button>
                                <div class="dropdown-menu">
                                    <a wire:click="export('Xlsx')" class="dropdown-item" href="javascript:void(0)"><i
                                          class="fa fa-file-excel mr-2"></i> Excel</a>
                                    <a wire:click="export('Csv')" class="dropdown-item" href="javascript:void(0)"><i
                                          class="fa fa-file-csv mr-2"></i> CSV</a>
                                </div>
                            </div>

                            @if($this->currentAdmin->can('cms.classrooms.delete'))
                            <button class="btn mr-1 mb-2 btn-danger dt-delete-selected"
                              @if(count($this->getSelectedRows()) === 0) disabled @endif>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 mb-2 text-md-left text-center">
                            ...
                            <select wire:model="perPage"
                              class="custom-select custom-select-sm form-control form-control-sm dt-per-page-selector">
                            ...
                            <div>
                                <label>
                                    ...
                                    <input type="text" wire:model.debounce.700ms="search"
                                      class="form-control form-control-sm dt-search-input" />
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dt-center-container">
                        ...
                        <table
                          class="table mt-5 mb-5 table-hover table-bordered datatable-sortable table-responsive table-responsive-sm table-responsive-md table-responsive-lg">
                            <thead>
                                <tr>
                                    <th style="width: 60px;">
                                        <label class="checkbox checkbox-outline checkbox-primary">
                                            <input wire:model="selectAllRows" wire:click="toggleSelectAllRows"
                                              type="checkbox" name="selectAllRows"><span></span>
                                        </label>
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <label class="checkbox checkbox-outline checkbox-primary">
                                            <input wire:model="selectedRows.{{ $item->getKey() }}" type="checkbox"
                                              name="selectedRows_{{ $item->getKey() }}"><span></span>
                                        </label>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button wire:click="performAction('edit', '{{ $item->getKey() }}')"
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-4 mb-3 text-md-left text-center">
                            Showing {{ $this->data->firstItem() }} to {{ $this->data->lastItem() }} of {{
                            $this->data->total() }} entries
                        </div>

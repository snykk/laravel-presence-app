                        ...
                        <div class="mt-16 mb-16">
                            ...
                            @foreach($componentImagesEn as $key => $image)
                                ...
                                >
                                    ...
                                    <button wire:click="removeFileItem('En', {{ $key }})" type="button" class="btn btn-danger">Remove File Item</button>
                                </div>
                            @endforeach

                            <button wire:click="addFileItem('En')" type="button" class="btn btn-primary">Add File Item</button>
                        </div>
                        ...
                        <div class="mt-16 mb-16">
                            ...
                            @foreach($componentImagesId as $key => $image)
                                ...
                                >
                                    ...
                                    <button wire:click="removeFileItem('Id', {{ $key }})" type="button" class="btn btn-danger">Remove File Item</button>
                                </div>
                            @endforeach

                            <button wire:click="addFileItem('Id')" type="button" class="btn btn-primary">Add File Item</button>
                        </div>

        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Ctas</h3>
                    <div class="card-toolbar">
                        @if($this->currentAdmin->can('cms.ctas.create'))
                            <button wire:click="performAction('create')" type="button" class="btn mr-1 btn-primary">
                                <i class="fa fa-plus"></i> New Cta
                            </button>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-md-12 text-md-right text-center">
                            ...
                            @if($this->currentAdmin->can('cms.ctas.delete'))
                    ...
                    <div class="dt-center-container">
                        ...
                        <table class="table mt-5 mb-5 table-hover table-bordered datatable-sortable table-responsive-sm table-responsive-md table-responsive-lg">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button wire:click="performAction('show', '{{ $item->getRouteKey() }}')" class="btn btn-xs btn-icon mr-1 btn-primary">
                                        <i class="fa fa-eye icon-nm"></i>
                                    </button>

                                    @if($this->currentAdmin->can('cms.ctas.update'))
                                        <button wire:click="performAction('edit', '{{ $item->getRouteKey() }}')" class="btn btn-xs btn-icon mr-1 btn-warning">

        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Edit Home Banner #{{ $homeBanner->getKey() }}</h3>
                </div>
                <div class="card-body">
                                ...
                                <div class="tab-pane fade p-2 active show" id="-en" role="tabpanel">
                                    <div class="mb-20">
                                        <div class="form-group">
                                            ...
                                            <div class="font-size-sm mt-2 text-info">It is recommended to upload an
                                                image with 2400x1200 resolution.
                                            </div>
                                        </div>
                                    ...
                                    <div class="mb-20">
                                        <div class="form-group">
                                            ...
                                            <x-media-library-attachment name="homeBannerMobileEn"
                                              rules="{{ $mediaRules['image'] }}" />
                                            <div class="font-size-sm mt-2 text-info">It is recommended to upload an
                                                image with 1200x1200 resolution.
                                            </div>
                                        </div>

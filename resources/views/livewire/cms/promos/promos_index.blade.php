            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        @if($this->currentAdmin->can('cms.promos.create'))
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-md-12 text-md-right text-center">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="{{url('/promos/guide/')}}"><i class="fa fa-reply mr-2"></i> Guide</a>
                                    <a class="dropdown-item" href="{{url('/promos/template/')}}"><i class="fa fa-reply mr-2"></i> Template</a>
                                    <a wire:click="performAction('import')" class="dropdown-item"><i class="fa fa-file-upload mr-2"></i> Import</a>
                                </div>
                            </div>

                            @if($this->currentAdmin->can('cms.promos.delete'))
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            ...
            $('.dt-delete-selected').click(function (event) {
                if (confirm('Do you really wish to continue?')) {
                    @this.deleteSelectedRelatedBanner();
                    @this.deleteSelected();
                }
                else {
                    event.preventDefault();

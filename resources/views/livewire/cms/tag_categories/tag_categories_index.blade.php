...
<script type="text/javascript">
    window.resourceUrl = '{{ route('cms.tag_categories.index') }}';
</script>
@endsection
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Tag Categories</h3>
                    <div class="card-toolbar">
                        @if($this->currentAdmin->can('cms.tag_categories.create'))
                            <button wire:click="performAction('create')" type="button" class="btn mr-1 btn-primary">
                                <i class="fa fa-plus"></i> New Tag Category
                            </button>
                        @endif
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <div class="row mb-4">
                        <div class="col-sm-12 col-md-12 text-md-right text-center">
                            ...
                            @if($this->currentAdmin->can('cms.tag_categories.delete'))
                        ...
                        <table class="table mt-5 mb-5 table-hover table-bordered datatable-sortable table-responsive-sm table-responsive-md table-responsive-lg">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($this->currentAdmin->can('cms.tag_categories.update'))

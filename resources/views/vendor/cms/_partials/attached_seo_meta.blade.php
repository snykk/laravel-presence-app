...
<div class="mt-16 mb-16">
    ...
    @multilingual('attached-seo-meta')
        {!! CmsForm::text('seoMeta.seo_title', $component->getSeoFormAttribute())->setTitle('Title') !!}
        @multiSeoTitleCharCount
        {!! CmsForm::textarea('seoMeta.seo_description', $component->getSeoFormAttribute())->setTitle('Description') !!}
        @multiSeoDescCharCount
        {!! CmsForm::text('seoMeta.seo_keyword', $component->getSeoFormAttribute())->setTitle('Keyword') !!}
        @multiSeoKeywordCharCount

...
use App\Http\Livewire\Cms\ArticleCategories\ArticleCategoriesIndex;
...
class ArticleCategoriesIndexTest extends TestCase
{
    ...
    {
        Livewire::test('cms.article-categories.article-categories-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(ArticleCategoriesIndex::class, $data);

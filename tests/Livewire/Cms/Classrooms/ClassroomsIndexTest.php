...
use App\Http\Livewire\Cms\Classrooms\ClassroomsIndex;
...
class ClassroomsIndexTest extends TestCase
{
    use CmsTests;
    ...
    {
        Livewire::test('cms.classrooms.classrooms-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(ClassroomsIndex::class, $data);

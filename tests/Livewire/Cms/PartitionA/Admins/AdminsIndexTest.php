...
namespace Tests\Livewire\Cms\PartitionA\Admins;

use App\Http\Livewire\Cms\Admins\AdminsIndex;
...
class AdminsIndexTest extends TestCase
{
    use CmsTests;
    ...
    {
        Livewire::test('cms.admins.admins-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(AdminsIndex::class, $data);

...
use App\Http\Livewire\Cms\Components\ComponentsIndex;
...
class ComponentsIndexTest extends TestCase
{
    use CmsTests;
    ...
    {
        Livewire::test('cms.components.components-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(ComponentsIndex::class, $data);

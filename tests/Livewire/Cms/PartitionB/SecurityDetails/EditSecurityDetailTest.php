...
class EditSecurityDetailTest extends TestCase
{
    use CmsTests;
    ...
    {
        Livewire::test('cms.security-details.edit-security-detail', ['securityDetail' => $this->securityDetail])
            ->assertHasNoErrors();
    }

    /** @test */
    public function it_can_update_the_existing_security_detail_record()
    {
        ...
        self::assertEquals('The security detail has been updated.', session('alertMessage'));
    }

    /** @test */
    public function it_can_cancel_updating_existing_security_detail_and_go_back_to_index_page()
    {
        $data = $this->fakeRawData(SecurityDetail::class);
        $translations = $this->fakeTranslationData(SecurityDetail::class);

...
use App\Http\Livewire\Cms\TipsApps\TipsAppsIndex;
...
class TipsAppsIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        TipsApp::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.tips-apps.tips-apps-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(TipsAppsIndex::class, $data);

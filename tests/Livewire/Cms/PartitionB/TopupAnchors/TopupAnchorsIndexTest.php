...
use App\Http\Livewire\Cms\TopupAnchors\TopupAnchorsIndex;
...
class TopupAnchorsIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        TopupAnchor::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.topup-anchors.topup-anchors-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(TopupAnchorsIndex::class, $data);

...
use App\Http\Livewire\Cms\Promos\PromosIndex;
...
class PromosIndexTest extends TestCase
{
    use CmsTests;
    ...
    {
        Livewire::test('cms.promos.promos-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(PromosIndex::class, $data);

...
use App\Http\Livewire\Cms\TopupMethods\TopupMethodsIndex;
...
class TopupMethodsIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        TopupMethod::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.topup-methods.topup-methods-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(TopupMethodsIndex::class, $data);

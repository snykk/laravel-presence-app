...
class EditTopupVendorTest extends TestCase
{
    use CmsTests;
    ...
    {
        Livewire::test('cms.topup-vendors.edit-topup-vendor', ['topupVendor' => $this->topupVendor])
            ->assertHasNoErrors();
    }

    /** @test */
    public function it_can_update_the_existing_topup_vendor_record()
    {
        ...
        self::assertEquals('The topup vendor has been updated.', session('alertMessage'));
    }

    /** @test */
    public function it_can_cancel_updating_existing_topup_vendor_and_go_back_to_index_page()
    {
        $data = $this->fakeRawData(TopupVendor::class);
        $translations = $this->fakeTranslationData(TopupVendor::class);

...
use App\Http\Livewire\Cms\TopupVendors\TopupVendorsIndex;
...
class TopupVendorsIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        TopupVendor::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.topup-vendors.topup-vendors-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(TopupVendorsIndex::class, $data);

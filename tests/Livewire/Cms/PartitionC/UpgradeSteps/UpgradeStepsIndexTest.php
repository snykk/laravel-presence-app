...
use App\Http\Livewire\Cms\UpgradeSteps\UpgradeStepsIndex;
...
class UpgradeStepsIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        UpgradeStep::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.upgrade-steps.upgrade-steps-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(UpgradeStepsIndex::class, $data);

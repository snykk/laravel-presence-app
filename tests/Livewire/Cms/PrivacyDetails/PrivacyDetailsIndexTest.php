...
use App\Http\Livewire\Cms\PrivacyDetails\PrivacyDetailsIndex;
...
class PrivacyDetailsIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        PrivacyDetail::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.privacy-details.privacy-details-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(PrivacyDetailsIndex::class, $data);

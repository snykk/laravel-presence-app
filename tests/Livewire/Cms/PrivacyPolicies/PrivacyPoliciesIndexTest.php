...
use App\Http\Livewire\Cms\PrivacyPolicies\PrivacyPoliciesIndex;
...
class PrivacyPoliciesIndexTest extends TestCase
{
    use CmsTests;
    ...
    public function setUp(): void
    {
        ...
        PrivacyPolicy::factory(3)->create();
    }

    /** @test */
    public function datatable_component_is_accessible()
    {
        Livewire::test('cms.privacy-policies.privacy-policies-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(PrivacyPoliciesIndex::class, $data);

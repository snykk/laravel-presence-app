...
use App\Http\Livewire\Cms\Schedules\SchedulesIndex;
...
class SchedulesIndexTest extends TestCase
{
    use CmsTests;
    ...
    {
        Livewire::test('cms.schedules.schedules-index')
            ->assertHasNoErrors();
    }
    ...
    public function it_can_load_its_state_from_the_session_store()
    {
        ...
        session()->put(SchedulesIndex::class, $data);
